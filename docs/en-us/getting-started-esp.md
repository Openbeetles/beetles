...
This page gets Beetls OS from an ESP32 build to a first successful chat reply.
...
If the device is already on your local network, open its current local IP instead.
