...
fn storage_contention_risk_from_metrics(
    ...
    if metrics.storage_lock_hold_last_us >= 1_000_000 || metrics.storage_lock_wait_last_us >= 50_000
    {
        StorageContentionRisk::Critical
    } else if metrics.storage_lock_hold_last_us >= 200_000
        || metrics.storage_lock_wait_last_us >= 5_000
    {
