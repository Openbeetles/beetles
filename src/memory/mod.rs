...
pub use archive_search::{
    ...
    ArchiveSearchQueryReport, ArchiveSearchResult, ArchiveSearchSourceStats,
    MAX_ARCHIVE_GET_CONTENT_LEN, MAX_ARCHIVE_SEARCH_LIMIT, archive_get_default_content_len,
    get_archive_record, search_archive_records, search_archive_records_detailed,
};
...
pub use continuity_snapshot::{
    ...
    ContinuitySnapshotMode, export_continuity_snapshot, import_continuity_snapshot,
    render_continuity_snapshot_markdown,
};
pub use core_revision_ledger::{
    ...
    CoreRevisionRecordChange, CoreRevisionTimelineEntry, append_core_revision_record,
    build_core_revision_timeline, compute_core_revision_governance_digest,
    core_revision_observation_due_at, correction_pressure, has_recent_matching_adopted_change,
    has_recent_matching_rejected_change, recent_adopted_revision, recent_rejected_direction_count,
...
pub use hygiene::{
    MemoryHygieneContext, MemoryHygieneInspection, MemoryHygieneOutcome, inspect_memory_hygiene,
    render_memory_hygiene_inspection_markdown,
};
...
pub(crate) use long_term::{
    LongTermMemoryMergeGuardDecision, canonicalize_long_term_memory_entry,
    compare_long_term_memory_query_results, govern_long_term_memory_entries,
    inspect_long_term_memory_merge_guard, long_term_memory_effective_stale_hint,
...
pub use persona_governance_benchmark::{
    PersonaGovernanceReplayCase, PersonaGovernanceReplayResult, run_persona_governance_replay_case,
    run_persona_governance_replay_suite,
};
pub use persona_priority::{
    ...
    should_run_persona_priority_adjudication,
};
#[cfg(not(any(target_arch = "xtensa", target_arch = "riscv32")))]
...
pub use personality_closure::{
    ...
    PersonalityGovernanceInspectionInput, inspect_personality_governance,
...
pub use recall_inspection::{
    WorkingRecallInspection, WorkingRecallInspectionInput, inspect_working_recall,
...
pub use recent_persona_evidence::{
    ...
    RecentPersonaEvidence, derive_recent_persona_evidence, load_recent_persona_evidence,
    render_recent_persona_evidence_block,
};
pub use relationship_constitution::{
    REL_PATH_RELATIONSHIP_CONSTITUTIONS, RelationshipBoundaryShift, RelationshipConstitution,
...
pub use relationship_portfolio::{
    REL_PATH_RELATIONSHIP_PORTFOLIOS, RelationshipGovernanceState, RelationshipInheritanceMode,
    RelationshipPortfolio, RelationshipPortfolioEntry, RelationshipPortfolioSelectorInput,
    RelationshipPortfolioStore, RelationshipPortfolioSyncOutcome,
...
pub use relationship_topology::{
    REL_PATH_RELATIONSHIP_TOPOLOGIES, RelationshipSelectionTarget, RelationshipSelectorInput,
    RelationshipTopology, RelationshipTopologyEntry, RelationshipTopologyRefreshOutcome,
    RelationshipTopologyStore, RelationshipTopologyUpsertInput, render_relationship_topology_block,
    select_relationship_topology_targets, upsert_relationship_topology_entry,
};
pub use self_authored_core::{
    SELF_AUTHORED_CORE_SYSTEM_PROMPT, SELF_AUTHORED_CORE_TOTAL_CHAR_LIMIT, SelfAuthoredCore,
...
pub use self_scope::{BOARD_SUBJECT_SCOPE_ID, board_subject_scope_id, relationship_scope_id};
pub use self_state::{
...
pub use shared_memory_governance::{
    SharedMemoryWriteAction, SharedMemoryWriteItemReport, SharedMemoryWriteOutcome,
    SharedMemoryWriteReason, SharedMemoryWriteSource, write_governed_shared_memory,
};
...
pub use turn_ledger::{
    ...
    TURN_LEDGER_HISTORY_MAX_ITEMS, TurnDeliveryLedger, TurnLedger, TurnLedgerStatus,
    TurnLedgerStore, TurnPersonaDisclosureLedger, TurnPersonaLedger, TurnPersonaPressureLevel,
    TurnPersonaPriorityLedger, TurnPersonaReviewLedger, build_turn_ledger_start,
    build_turn_persona_disclosure_ledger, build_turn_persona_priority_ledger,
    normalize_turn_persona_scope, normalize_turn_persona_targets, normalize_turn_preview,
    normalize_turn_reason, render_turn_persona_ledger_block, turn_ledger_observed_at_ms,
};
