...
impl ToolContext for HttpClientToolContext<'_> {
    ...
    fn get_streaming_with_headers(
        ...
        self.http
            .get_streaming(url, headers, max_response_bytes, on_chunk)
    }
...
impl crate::office::OfficeHttpClient for HttpClientToolContext<'_> {
    fn request_with_headers(
        &mut self,
        method: &str,
        url: &str,
    ...
    fn get_streaming_with_headers(
        ...
        max_response_bytes: Option<usize>,
        on_chunk: &mut dyn FnMut(&[u8]) -> Result<()>,
    ) -> Result<crate::office::OfficeStreamingResponse> {
        ...
        Ok(crate::office::OfficeStreamingResponse {
            status,
...
impl PlatformHttpClient for ToolContextHttpClient<'_> {
    ...
    fn get_streaming(
        ...
        self.ctx
            .get_streaming_with_headers(url, headers, max_response_bytes, on_chunk)
    }
...
impl crate::office::OfficeHttpClient for ToolContextHttpClient<'_> {
    fn request_with_headers(
        &mut self,
        method: &str,
        url: &str,
    ...
    fn get_streaming_with_headers(
        ...
        let mut streamed_bytes = 0usize;
        let limit = max_response_bytes.filter(|value| *value > 0);
        let status = self.ctx.get_streaming_with_headers(
            url,
            headers,
            max_response_bytes,
            &mut |chunk| {
