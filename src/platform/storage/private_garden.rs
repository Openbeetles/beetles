//! storage 实现的私有花园。索引单文件，正文分 chat 目录保存。
...
impl Default for StoragePrivateGardenStore {
    fn default() -> Self {
        Self::new()
    }
}

impl PrivateGardenStore for StoragePrivateGardenStore {
...
mod tests {
    ...
    fn indexed_doc_with_missing_body_fails_closed_on_read() {
        ...
        let store = StoragePrivateGardenStore::new();
        ...
        let reloaded = StoragePrivateGardenStore::new();
        let error = reloaded
