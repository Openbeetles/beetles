//! storage 实现的执行状态存储。单文件 memory/execution_states.json。
...
pub struct StorageExecutionStateStore {
    store: ChatScopedCachedJsonMapStore<StoredExecutionState>,
}

impl StorageExecutionStateStore {
    pub fn new() -> Self {
        Self {
...
impl Default for StorageExecutionStateStore {
    fn default() -> Self {
        Self::new()
    }
}

impl ExecutionStateStore for StorageExecutionStateStore {
