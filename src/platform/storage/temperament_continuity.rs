//! storage 实现的 Temperament Continuity 存储。单文件 memory/temperament_continuities.json。
...
pub struct StorageTemperamentContinuityStore {
    store: ChatScopedCachedJsonMapStore<StoredTemperamentContinuity>,
}

impl StorageTemperamentContinuityStore {
    pub fn new() -> Self {
        Self {
...
impl Default for StorageTemperamentContinuityStore {
    fn default() -> Self {
        Self::new()
    }
}

impl TemperamentContinuityStore for StorageTemperamentContinuityStore {
