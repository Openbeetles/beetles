//! storage implementation of mental privacy state store.
...
pub struct StorageMentalPrivacyStore {
    store: ChatScopedCachedJsonMapStore<StoredMentalPrivacyState>,
}

impl StorageMentalPrivacyStore {
    pub fn new() -> Self {
        Self {
...
impl Default for StorageMentalPrivacyStore {
    fn default() -> Self {
        Self::new()
    }
}

impl MentalPrivacyStore for StorageMentalPrivacyStore {
