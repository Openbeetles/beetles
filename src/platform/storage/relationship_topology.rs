//! storage implementation of Relationship Topology store. Single-file JSON map.
...
pub struct StorageRelationshipTopologyStore {
    store: ChatScopedCachedJsonMapStore<StoredRelationshipTopology>,
}

impl StorageRelationshipTopologyStore {
    pub fn new() -> Self {
        Self {
...
impl Default for StorageRelationshipTopologyStore {
    fn default() -> Self {
        Self::new()
    }
}

impl RelationshipTopologyStore for StorageRelationshipTopologyStore {
