//! storage implementation of Relationship Constitution store. Single-file JSON map.
...
pub struct StorageRelationshipConstitutionStore {
    store: ChatScopedCachedJsonMapStore<StoredRelationshipConstitution>,
}

impl StorageRelationshipConstitutionStore {
    pub fn new() -> Self {
        Self {
...
impl Default for StorageRelationshipConstitutionStore {
    fn default() -> Self {
        Self::new()
    }
}

impl RelationshipConstitutionStore for StorageRelationshipConstitutionStore {
