//! storage 实现的会话摘要存储。单文件 memory/session_summaries.json，chat 数上界 32。
...
pub struct StorageSessionSummaryStore {
    store: ChatScopedCachedJsonMapStore<SummaryEntry>,
}

impl StorageSessionSummaryStore {
    pub fn new() -> Self {
        StorageSessionSummaryStore {
...
impl Default for StorageSessionSummaryStore {
    fn default() -> Self {
        Self::new()
    }
}

impl SessionSummaryStore for StorageSessionSummaryStore {
