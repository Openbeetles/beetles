//! storage 实现的 Self Continuity 存储。单文件 memory/self_continuities.json。
...
pub struct StorageSelfContinuityStore {
    store: ChatScopedCachedJsonMapStore<StoredSelfContinuity>,
}

impl StorageSelfContinuityStore {
    pub fn new() -> Self {
        Self {
...
impl Default for StorageSelfContinuityStore {
    fn default() -> Self {
        Self::new()
    }
}

impl SelfContinuityStore for StorageSelfContinuityStore {
