//! storage 实现的 Self Model 存储。单文件 memory/self_models.json。
...
pub struct StorageSelfModelStore {
    store: ChatScopedCachedJsonMapStore<StoredSelfModel>,
}

impl StorageSelfModelStore {
    pub fn new() -> Self {
        Self {
...
impl Default for StorageSelfModelStore {
    fn default() -> Self {
        Self::new()
    }
}

impl SelfModelStore for StorageSelfModelStore {
