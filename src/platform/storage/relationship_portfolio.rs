//! storage implementation of Relationship Portfolio store. Single-file JSON map.
...
pub struct StorageRelationshipPortfolioStore {
    store: ChatScopedCachedJsonMapStore<StoredRelationshipPortfolio>,
}

impl StorageRelationshipPortfolioStore {
    pub fn new() -> Self {
        Self {
...
impl Default for StorageRelationshipPortfolioStore {
    fn default() -> Self {
        Self::new()
    }
}

impl RelationshipPortfolioStore for StorageRelationshipPortfolioStore {
