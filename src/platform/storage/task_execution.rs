//! storage / state-root backed stores for the P3-A task workspace plane.
...
pub struct StorageTaskRunStore {
    index: CachedJsonFileStore<HashMap<String, RunIndexEntry>>,
}

impl StorageTaskRunStore {
    pub fn new() -> Self {
        Self {
...
impl Default for StorageTaskRunStore {
    fn default() -> Self {
        Self::new()
    }
}

impl TaskRunStore for StorageTaskRunStore {
...
pub struct StorageTaskArtifactStore;

impl StorageTaskArtifactStore {
    pub fn new() -> Self {
        Self
    }
}

impl Default for StorageTaskArtifactStore {
    fn default() -> Self {
        Self::new()
    }
}

impl TaskArtifactStore for StorageTaskArtifactStore {
...
pub struct StorageTaskExecutionLedgerStore;

impl StorageTaskExecutionLedgerStore {
    pub fn new() -> Self {
        Self
    }
}

impl Default for StorageTaskExecutionLedgerStore {
    fn default() -> Self {
        Self::new()
    }
}

impl TaskExecutionLedgerStore for StorageTaskExecutionLedgerStore {
...
pub struct StorageTaskLearningStore {
    index: CachedJsonFileStore<HashMap<String, LearningIndexEntry>>,
}

impl StorageTaskLearningStore {
    pub fn new() -> Self {
        Self {
            index: CachedJsonFileStore::new(
                learning_index_path,
...
impl Default for StorageTaskLearningStore {
    fn default() -> Self {
        Self::new()
    }
}

impl TaskLearningStore for StorageTaskLearningStore {
