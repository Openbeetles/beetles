//! storage 实现的 Felt Significance 存储。单文件 memory/felt_significances.json。
...
pub struct StorageFeltSignificanceStore {
    store: ChatScopedCachedJsonMapStore<StoredFeltSignificance>,
}

impl StorageFeltSignificanceStore {
    pub fn new() -> Self {
        Self {
...
impl Default for StorageFeltSignificanceStore {
    fn default() -> Self {
        Self::new()
    }
}

impl FeltSignificanceStore for StorageFeltSignificanceStore {
