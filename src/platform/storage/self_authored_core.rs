//! storage implementation of Self-Authored Core store. Single-file JSON map.

use crate::error::Result;
use crate::memory::{SelfAuthoredCore, SelfAuthoredCoreStore, REL_PATH_SELF_AUTHORED_CORES};
...
pub struct StorageSelfAuthoredCoreStore {
    store: ChatScopedCachedJsonMapStore<StoredSelfAuthoredCore>,
}

impl StorageSelfAuthoredCoreStore {
    pub fn new() -> Self {
        Self {
...
impl Default for StorageSelfAuthoredCoreStore {
    fn default() -> Self {
        Self::new()
    }
}

impl SelfAuthoredCoreStore for StorageSelfAuthoredCoreStore {
