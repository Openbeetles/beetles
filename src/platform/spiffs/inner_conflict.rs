//! SPIFFS 实现的 Inner Conflict 存储。单文件 memory/inner_conflicts.json。
...
pub struct SpiffsInnerConflictStore {
    store: ChatScopedCachedJsonMapStore<StoredInnerConflict>,
}

impl SpiffsInnerConflictStore {
    pub fn new() -> Self {
        Self {
...
impl Default for SpiffsInnerConflictStore {
    fn default() -> Self {
        Self::new()
    }
}

impl InnerConflictStore for SpiffsInnerConflictStore {
