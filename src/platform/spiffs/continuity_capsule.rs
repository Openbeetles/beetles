//! SPIFFS / state-root backed continuity capsule store.
...
impl Default for SpiffsContinuityCapsuleStore {
    fn default() -> Self {
        Self::new()
    }
}

impl ContinuityCapsuleStore for SpiffsContinuityCapsuleStore {
    fn upsert_many(
        &self,
