//! SPIFFS-backed detached background work store.
//! 基于 SPIFFS 的 detached 后台工作存储。
...
pub struct SpiffsDetachedWorkStore {
    store: CachedJsonFileStore<StoredDetachedWorkMap>,
}

impl SpiffsDetachedWorkStore {
    pub fn new() -> Self {
        Self {
...
impl Default for SpiffsDetachedWorkStore {
    fn default() -> Self {
        Self::new()
    }
}

impl DetachedWorkStore for SpiffsDetachedWorkStore {
