//! SPIFFS 实现的 Outer Voice 存储。单文件 memory/outer_voices.json。
...
pub struct SpiffsOuterVoiceStore {
    store: ChatScopedCachedJsonMapStore<StoredOuterVoice>,
}

impl SpiffsOuterVoiceStore {
    pub fn new() -> Self {
        Self {
...
impl Default for SpiffsOuterVoiceStore {
    fn default() -> Self {
        Self::new()
    }
}

impl OuterVoiceStore for SpiffsOuterVoiceStore {
