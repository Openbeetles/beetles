//! SPIFFS-backed active foreground work store.
//! 基于 SPIFFS 的前台主工作存储。
...
pub struct SpiffsActiveWorkStore {
    store: ChatScopedCachedJsonMapStore<StoredActiveWork>,
}

impl SpiffsActiveWorkStore {
    pub fn new() -> Self {
        Self {
...
impl Default for SpiffsActiveWorkStore {
    fn default() -> Self {
        Self::new()
    }
}

impl ActiveWorkStore for SpiffsActiveWorkStore {
