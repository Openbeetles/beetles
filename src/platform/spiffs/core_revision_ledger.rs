...
pub struct SpiffsCoreRevisionLedgerStore {
    store: ChatScopedCachedJsonMapStore<StoredCoreRevisionLedger>,
}

impl SpiffsCoreRevisionLedgerStore {
    pub fn new() -> Self {
        Self {
...
impl Default for SpiffsCoreRevisionLedgerStore {
    fn default() -> Self {
        Self::new()
    }
}

impl CoreRevisionLedgerStore for SpiffsCoreRevisionLedgerStore {
