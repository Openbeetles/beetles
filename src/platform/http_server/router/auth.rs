...
use crate::platform::http_server::router::catalog::{
    ...
    ROUTE_DIAGNOSE, ROUTE_HARDWARE_DISCOVERY, ROUTE_MEMORY_MAINTENANCE, ROUTE_MEMORY_STATUS,
    ROUTE_METRICS, ROUTE_OPERATOR_STATUS, ROUTE_OPERATOR_WINDOW, ROUTE_RESOURCE, ROUTE_RESTART,
