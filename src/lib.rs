...
pub use reasoning::{
    ...
    ProgrammableReasoningBranchReplayRecord, ProgrammableReasoningCapabilityContract,
    ProgrammableReasoningCapabilityKind, ProgrammableReasoningDemoScenario,
    ProgrammableReasoningDoctrineInspection, ProgrammableReasoningExecutionBackend,
    ...
    ProgrammableReasoningProductSurface, ProgrammableReasoningProposal,
    ProgrammableReasoningProposalKind, ProgrammableReasoningProposalScope,
    ProgrammableReasoningReplayInspection, ProgrammableReasoningRuntimeContract,
